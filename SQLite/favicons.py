def chrome_favicons():
    ...
    sql_query = """
            ...
            */
            ...
            the source code at: https://cs.chromium.org/chromium/src/components/favicon_base/favicon_types.h?q
            =icon_type&g=0&l=86 lines 142-171
            ...
            */
            ...
            =icon_type%3D&ss=chromium (lines 37-82) */
            
            
            SELECT favicons.id, icon_mapping.page_url AS 'page URL', favicons.url  AS 'favicon URL', 
            favicon_bitmaps.image_data, (favicon_bitmaps.height || " X " || favicon_bitmaps.width) AS "icon 
            dimensions", favicons.icon_type,
            /* REF: 
            https://source.chromium.org/chromium/chromium/src/+/main:out/android-Debug/gen/components/favicon/android
            /java/generated_java/input_srcjars/org/chromium/components/favicon/IconType.java?q=touch_precomposed_icon
            &ss=chromium */ 
            CASE favicons.icon_type 
                ...
                ELSE "New value!: "||favicons.icon_type||" Check source code for meaning!" END AS "Icon Type",
            
            /*  reference:https://source.chromium.org/chromium/chromium/src/+/main:components/favicon_base
            /favicon_types.h?q=icon_type&ss=chromium - lines 88-92. */
            ...
            END AS 'Decoded last_updated (local time)',
