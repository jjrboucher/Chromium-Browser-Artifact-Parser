def downloads():
    ...
    sql_query = """
        ...
        */
        ...
        SELECT downloads.id AS "downloads.id", chains.chain_index AS "chain_index", current_path, target_path, start_time, datetime(start_time/1000000-11644473600,'unixepoch', 'localtime') AS "Decoded start_time (local time)",
